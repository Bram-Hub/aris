...
pub extern "system" fn Java_edu_rpi_aris_ast_Expression_toDebugString(
    env: JNIEnv,
    obj: JObject,
) -> jstring {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_edu_rpi_aris_ast_Expression_toString(
    env: JNIEnv,
    obj: JObject,
) -> jstring {
    with_thrown_errors(&env, |env| {
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_edu_rpi_aris_ast_Expression_equals(
    env: JNIEnv,
    this: JObject,
    other: JObject,
) -> jni::sys::jboolean {
    ...
    match &*name {
        ...
        "edu.rpi.aris.ast.Expression$ApplyExpression" => {
            let func = jobject_to_expr(
                env,
                env.get_field(obj, "func", "Ledu/rpi/aris/ast/Expression;")?
                    .l()?,
            )?;
            let mut args = vec![];
            java_iterator_for_each(
...
#[no_mangle]
#[allow(non_snake_case)]
pub extern "system" fn Java_edu_rpi_aris_ast_Expression_parseViaRust(
    env: JNIEnv,
    _cls: JClass,
    e: JString,
) -> jobject {
...
pub fn expr_to_jobject<'a>(env: &'a JNIEnv, e: Expr) -> jni::errors::Result<JObject<'a>> {
    ...
    let rec = |e: Expr| -> jni::errors::Result<JValue> {

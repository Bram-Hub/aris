    ...
    with_thrown_errors(&env, |env| {
        ...
        for (i, classification) in classifications.iter().enumerate() {
            ...
            let ty = match classification {
                ...
                BooleanInference => env.call_static_method("java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", &[cls, jv("BOOLEAN_INFERENCE")?])?,
                ConditionalInference => env.call_static_method("java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", &[cls, jv("CONDITIONAL_INFERENCE")?])?,
                BiconditionalInference => env.call_static_method("java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", &[cls, jv("BICONDITIONAL_INFERENCE")?])?,
                QuantifierInference => env.call_static_method("java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", &[cls, jv("QUANTIFIER_INFERENCE")?])?,
                BooleanEquivalence => env.call_static_method("java/lang/Enum", "valueOf", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;", &[cls, jv("BOOLEAN_EQUIVALENCE")?])?,
